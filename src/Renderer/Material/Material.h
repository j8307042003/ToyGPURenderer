...
{
public:
	virtual bool scatter(const glm::dvec3 & view, const glm::dvec3& wi, const SurfaceData& surface, /*HitInfo & hitInfo,*/ Color& attenuation/*, Ray3f& scattered*/) const = 0;
	virtual glm::vec3 Albedo(const SurfaceData & surface) const = 0;
	virtual glm::vec3 Emission(const SurfaceData& surface) const = 0;
